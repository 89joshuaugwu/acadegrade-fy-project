      ...
      <main>
        ...
        <section aria-labelledby="mobile-product-title" className="public-atmosphere-section border-y border-[var(--acade-border-subtle)] text-[var(--acade-text)]">
          <div className="mx-auto max-w-[1200px] px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
            <figure className="relative isolate min-h-[34rem] overflow-hidden rounded-[var(--radius-dialog)] border border-[var(--acade-border)] bg-[var(--acade-surface)] shadow-[var(--shadow-popover)] sm:min-h-[40rem] lg:min-h-[44rem]">
              <Image src={mobileShowcaseLight} alt="AcadeGrade mobile showcase featuring result scanning, dashboard, transcript and profile screens" fill priority={false} sizes="(max-width: 1200px) 100vw, 1200px" className="-z-20 object-cover object-center dark:hidden" />
              <Image src={mobileShowcaseDark} alt="" aria-hidden="true" fill priority={false} sizes="(max-width: 1200px) 100vw, 1200px" className="-z-20 hidden object-cover object-center dark:block" />
              <div className="absolute inset-0 -z-10 bg-gradient-to-b from-[var(--acade-deep)] via-[var(--acade-deep)]/78 to-transparent sm:via-[var(--acade-deep)]/48" aria-hidden="true" />

              <div className="relative m-4 max-w-2xl rounded-[var(--radius-surface)] border border-[var(--acade-border)] bg-[var(--acade-deep)]/92 p-5 shadow-[var(--shadow-card)] backdrop-blur-md sm:m-7 sm:p-7">
                <p className="text-sm font-semibold text-[var(--acade-primary)]">AcadeGrade for mobile</p>
                <h2 id="mobile-product-title" className="mt-2 max-w-[17ch] font-[family-name:var(--font-bricolage)] text-[clamp(2rem,5vw,3.25rem)] font-semibold leading-[1.06] tracking-[-0.04em]">
                ...
                <MobileAppDownload className="mt-5 justify-start" />
              </div>
