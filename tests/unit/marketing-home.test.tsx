...
describe('AcadeGrade landing presentation', () => {
  ...
  it('explains the calculation boundary without implying institutional certification', () => {
    ...
    expect(sequence).toHaveClass('min-w-0', 'lg:sticky', 'lg:top-24', 'lg:h-[40rem]');
    ...
    expect(stages[0]).toHaveClass('lg:translate-y-0');
    expect(stages[1]).toHaveClass('lg:translate-y-[34rem]', 'lg:opacity-0');
    expect(stages[2]).toHaveClass('lg:translate-y-[34rem]', 'lg:opacity-0');
    expect(stages[3]).toHaveClass('lg:translate-y-[34rem]', 'lg:opacity-0');
